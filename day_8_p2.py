to_process = r'''"azlgxdbljwygyttzkfwuxv"
...
"gk"
"\\zrs\\syur"'''
other = r'''"azlgxdbljwygyttzkfwuxv"
"v\xfb\"lgs\"kvjfywmut\x9cr"
"merxdhj"
"dwz"
"d\\gkbqo\\fwukyxab\"u"
...
for line in other.split('\n'):
    newly_encoded_count += len(line)
    newly_encoded_count += 2
    for char in line:
        if char in ['\\', '\"']:
            print('adding')
            newly_encoded_count += 1
print(f'newly encoded count minus original code count is {newly_encoded_count - code_count}')
